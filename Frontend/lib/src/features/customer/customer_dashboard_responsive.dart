// customer_dashboard_modern.dart
// Paste into lib/src/features/customer/customer_dashboard_modern.dart
// Modern, mobile-first, sliver-based Customer Dashboard.
// Wire route: GoRoute(path:'/customer/dashboard', builder: (_, __) => const CustomerDashboardModern())
...
// If you have design tokens or auth provider in your app, import them here.
// import '../../core/design_tokens.dart';
// import '../../core/auth_notifier.dart';

// For this file to be plug-and-play, I'll define minimal token values here.
// Replace with your project's design tokens if available.
class _DT {
...
/// Dummy auth provider usage — replace with your real provider import.
/// If you already have authNotifierProvider, keep using it. Here is a safe no-op provider:
final _dummyAuthProvider = Provider((ref) => {'name': 'User', 'initial': 'U'});

class CustomerDashboardModern extends ConsumerStatefulWidget {
  const CustomerDashboardModern({super.key});

  @override
  ConsumerState<CustomerDashboardModern> createState() =>
      _CustomerDashboardModernState();
}

class _CustomerDashboardModernState
    extends ConsumerState<CustomerDashboardModern>
    with TickerProviderStateMixin {
  final PageController _pageController = PageController(viewportFraction: 0.92);
  int _page = 0;
  Timer? _autoPlay;
  late final AnimationController _fadeController;
  // infinite promo page controller and autoplay timer
  late final PageController _promoPageController =
      PageController(viewportFraction: 0.92, initialPage: 1000);
  Timer? _promoAutoPlay;

// track pressed/hover states for buttons to animate micro-scale
  ...
  void initState() {
    ...
    // existing code you already had (page autoplay, fadeController etc.)
    ...
    // --- PROMO AUTOPLAY: start a timer that advances the promo PageView ---
  ...
  Widget build(BuildContext context) {
    // Use your auth provider here; example uses a dummy provider.
        ...
        child: FadeTransition(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              // extra bottom spacing so FAB never overlaps
